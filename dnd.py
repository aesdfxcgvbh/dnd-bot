...
reports = {"bot_online": ["{bot} был запущен {time}."
		   ...
		   "unexpected_error": ["Возникла непредвиденная ошибка. Уведомите администратора о ней, если её причина произошла с серверной стороны, в ином случае, повторите совершаемое действие.\n-# Известно о нестабильностях в последнее время со стороны самого Discord.\n```python\n{error}\n```"
								]
		   }
