...
statuses = ['Веди себя как заклинатель, колдунишка!', 'Получай, слащавый эльф!', 'Чё за заклинание он сотворяет?!', 'Передаю привет твоему божеству!', 'Бро, тебе нужно больше фехтовать.', 'Я готов очаровывать всех!', 'Гном, иди в шахту играй.', 'В утробу Селунэ, время отступать!', 'Я сейчас порву книгу заклинаний!', 'Это просто бардовское выступление!', 'Полурослик, чё ты делаешь?!', 'Магия работает!', 'Закрой харизмо-выдаватель!', 'Этот арбалет просто имба!', 'Я сидел в храме и молился весь год!', 'Если бы Гонд хотел, чтобы вы жили, он бы не выковал мой меч!', 'Я в Астральном плане прячусь!', 'Безмолвие со рта развей!', 'А для таких вообще латы создают?', 'Твоя сила набухнет от веры!', 'Саня, заклинание "Ужас" работает на них!', 'Не бойся, исчадие, изгнание будет не больно!', 'Ты под заклинанием "Слабоумие", ливни!', 'На в морду, орчище!', 'Поднимайся, союзник, быстрее! У МЕНЯ ТРУДНОПРОХОДИМАЯ МЕСТНОСТЬ, ЧЕРТ...', 'Вы тупые тролли! Я с вас поражаюсь!', 'Чёрт! Как Темпус позволил нам выиграть?!', 'Эй, гоблины, сейчас вам достанется девятой ячейкой!', 'Я содомировал дракона!', 'Бум, критическое попадание!']
